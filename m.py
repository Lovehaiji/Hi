...
bot = telebot.TeleBot('7189918662:AAE-0GVByiqQmOvG7-QzSP9epSWrrtnB0Qc')
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "😂 𝘽𝙨𝙙𝙠 𝘼𝙙𝙢𝙞𝙣 𝙃𝙤 𝙆𝙮𝙖 𝙏𝙪𝙢 ? 😒🤣:- @mklsuraj."
...
def clear_logs_command(message):
    ...
    if user_id in admin_id:
        ...
        response = "You have not purchased yet purchase now from :- @mklsuraj ❄."
    bot.reply_to(message, response)
...
def clear_users_command(message):
    ...
    if user_id in admin_id:
        ...
        response = "ꜰʀᴇᴇ ᴋᴇ ᴅʜᴀʀᴍ ꜱʜᴀʟᴀ ʜᴀɪ ᴋʏᴀ ᴊᴏ ᴍᴜ ᴜᴛᴛʜᴀ ᴋᴀɪ ᴋʜɪ ʙʜɪ ɢᴜꜱ ʀʜᴀɪ ʜᴏ ʙᴜʏ ᴋʀᴏ ꜰʀᴇᴇ ᴍᴀɪ ᴋᴜᴄʜ ɴʜɪ ᴍɪʟᴛᴀ ʙᴜʏ:- @mklsuraj 🙇."
    bot.reply_to(message, response)
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            response = "𝐏𝐥𝐞𝐚𝐬𝐞 𝐩𝐫𝐨𝐯𝐢𝐝𝐞🚀: /Attack  <𝐇𝐨𝐬𝐭> <𝐏𝐨𝐫𝐭> <𝐓𝐢𝐦𝐞>"  # Updated command syntax 
    else:
...
👉 𝐂𝐨𝐧𝐭𝐚𝐜𝐭 𝐚𝐧 𝐀𝐝𝐦𝐢𝐧 𝐨𝐫 𝐭𝐡𝐞 𝐎𝐰𝐧𝐞𝐫-@mklsuraj 𝐟𝐨𝐫 𝐚𝐩𝐩𝐫𝐨𝐯𝐚𝐥.
...
🤖 𝐀𝐯𝐚𝐢𝐥𝐚𝐛𝐥𝐞 𝐜𝐨𝐦𝐦𝐚𝐧𝐝𝐬:
💥 /Attack : 𝐌𝐞𝐭𝐡𝐨𝐝 𝐅𝐨𝐫 𝐁𝐠𝐦𝐢 𝐒𝐞𝐫𝐯𝐞𝐫𝐬. 
...
'''
    ...
    keyboard = telebot.types.InlineKeyboardMarkup()
    keyboard.add(
        telebot.types.InlineKeyboardButton("CANARY 🦅", url="https://t.me/+pE_GZwn83y0xZjll")
    )
...
def welcome_plan(message):
    user_name = message.from_user.first_name
    response = f'''🤩 𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐭𝐨 @mklsuraj 𝐃𝐃𝐎𝐒 𝐁𝐎𝐓 , 
...
𝟑. 𝐌𝐀𝐊𝐄 𝐒𝐔𝐑𝐄 𝐘𝐎𝐔 𝐉𝐎𝐈??𝐄𝐃 https://t.me/+pE_GZwn83y0xZjll 𝐎𝐓𝐇𝐄𝐑𝐖𝐈𝐒𝐄 𝐍𝐎𝐓 𝐖𝐎𝐑𝐊
